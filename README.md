### $${\color{blue}Spectrally}$$: A simple, intuitive workflow for spectral analysis
...
### <span style="color: blue; font-family: inherit;">Spectrally</span>: A simple, intuitive workflow for spectral analysis
